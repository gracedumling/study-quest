        ...
        <div className="bg-card shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            ...
            <div className="mt-6">
              {activeTab === 'normal' && (
                <>
                  {renderLeaderboardTable(normalLeaderboard || [])}
                  {renderMobileLeaderboard(normalLeaderboard || [])}
                </>
              )}
              
              {activeTab === 'suddenDeath' && (
                <>
                  {renderLeaderboardTable(suddenDeathLeaderboard || [])}
                  {renderMobileLeaderboard(suddenDeathLeaderboard || [])}
                </>
              )}
            </div>
          </div>
